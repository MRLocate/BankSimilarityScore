...
#Comparison to First Hawaiian Bank Internal Peer List

Here is a list of the banks on the FHB peer list and how the similarity scores look for this process.

```{r FHBIntPeerList}

FHBIntPeerList = BankData[c(5816,3258,2838,4124,3822,4876,1847,406,714,4669,4849,
                            3637,4353,4272,2663,76,2539,2759,2752,5484,3294),]

FHBIntPeerList[,"PeerListName"] = c("First Hawaiian Bank",
                                    "First Horizon National Corporation",
                                    "First Republic Bank","MB Financial Inc",
                                    "Commerce Bancshares Inc",
                                    "SVB Financial Group",
                                    "Western Alliance Bancorp",
                                    "Umpqua Holdings Corp","East West Bancorp",
                                    "Webster Financial Corp","Bank of Hawaii",
                                    "Territorial Bancorp",
                                    "Central Pacific Financial Corp",
                                    "Cullen/Frost Bankers Inc","F.N.B. Corp",
                                    "United Bankshares Inc",
                                    "United Bankshares Inc",
                                    "Synovus Financial Corp","BankUnited Inc",
                                    "Associated Banc-Corp","PacWest Bancorp")
  
FHBIntPeerList[order(FHBIntPeerList[,"SimScoreFHB"]),c("Financial.Institution.Name","PeerListName","SimScoreFHB")]
